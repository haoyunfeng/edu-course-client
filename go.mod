module github.com/haoyunfeng/edu-course-client

go 1.25.3

require (
	github.com/gin-gonic/gin v1.9.1
	github.com/haoyunfeng/edu-course-proto v1.0.1
...
// 使用 git 仓库直接引用 proto 模块
// 如果遇到校验问题，可以使用以下方式之一：
// 1. 使用 HTTPS URL
// replace github.com/haoyunfeng/edu-course-proto => github.com/haoyunfeng/edu-course-proto v1.0.1
// 2. 使用 commit hash (从 git ls-remote 获取)
